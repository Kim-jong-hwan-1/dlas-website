...
from PySide6.QtGui import QPixmap, QCursor, QMouseEvent, QIcon, QGuiApplication  # ✅ 여기
...
class ClickableImage(QLabel):
    def __init__(self, module_name, enabled=True, callback=None):
        ...
        image_path = f"{module_name.lower().replace(' ', '_')}.png"
...
class ModuleSelectionWindow(QMainWindow):
    def __init__(self, available_modules):
        super().__init__()
        self.setWindowTitle("DLAS FAST STL REDUCER")
        ...
        title_pixmap = QPixmap("modules.png")
    ...
    def module_selected(self, module_name):
        ...
        filename = module_name.lower().replace(" ", "_") + ".py"
        try:
