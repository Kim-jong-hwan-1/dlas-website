 ...
 /////////////////////////////////////////////////////////////////////
  en: {
    ...
    download: { 
      ...
      desc: {
        line1: "Windows installer file only.",
        line2: "Just run the file – no need to unzip. (Not available for Mac.)",
  ...
  ko: {
    ...
    download: { 
      title: "소프트웨어 다운로드",
      desc: {
        line1: "Windows 전용 설치 파일입니다.",
        line2: "압축을 풀 필요 없이 바로 실행하세요. (Mac 미지원)",
