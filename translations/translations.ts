 ...
 /////////////////////////////////////////////////////////////////////
  en: {
   ...
   freeLicense: {
    ...
    step2: `2) Like our post: <a href="https://www.instagram.com/p/CokRraVPEi1/" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">here</a> and take a screenshot.`,
    ...
    payment: {
      ...
      items: [
         "Transfer Jig Maker is currently available.",
  ...
  "The final payment amount may vary depending on the tax laws and regulations of your country.",
      ],
...
- E-mail: support@dlas.io`,
  ...
  ko: {
   ...
   freeLicense: {
    ...
    step2: `2) 게시글에 <a href="https://www.instagram.com/p/CokRraVPEi1/" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">좋아요</a>를 누른 후 스크린샷을 찍어주세요.`,
    ...
    payment: {
      ...
      items: [
        ...
        "Inner(exo) 두 번의 프로세싱이 진행되는 버그가 있습니다.",
        "Inner+hole(exo) 모드에서는 2배의 세멘 값이 내면에 적용되는 버그가 있습니다. 절반의 양을 입력해 주세요.",
        "OpenSCAD 패스 설정이 필요할 수 있습니다.",
        "FAST IMAGE CONVERTER도 제공됩니다. (STL을 이미지로 빠르게 변환합니다.)",
        "일부 기능은 컴퓨터 환경에 따라 작동하지 않을 수 있습니다.",
        "구매 금액은 고객이 거주하는 국가의 세법 및 조세 정책에 따라 달라질 수 있습니다.대한민국 고객의 경우, 결제 금액은 환율과 관계없이 원화 기준으로 500,000원으로 고정되며, 부가가치세(VAT)는 별도입니다. 총 결제 금액: 550,000원 (VAT 포함)",
      ],
      footer:
