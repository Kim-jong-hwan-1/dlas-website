 ...
 /////////////////////////////////////////////////////////////////////
  en: {
   ...
   freeLicense: {
    ...
    send: `Then send all the screenshots to <strong>support@dlas.io</strong> with the email subject line <strong>dlas (your dlas ID)</strong>.`,
...
- E-mail: support@dlas.io`,
  ...
  ko: {
   ...
   freeLicense: {
    ...
    send: `<strong>support@dlas.io</strong>로 모든 스크린샷을 보내주세요. 이메일 제목은 <strong>dlas (본인의 dlas ID)</strong> 형식으로 작성해주세요.`,
