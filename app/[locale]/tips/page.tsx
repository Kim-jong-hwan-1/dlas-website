        ...
        <section className="py-20 px-6 relative min-h-screen">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-[#f8fafc]">{t("tipsPage.share4Title")}</h3>
                  <p className="text-[#f8fafc]/60 mb-4">{t("tipsPage.share4Desc")}</p>
                  <a
                    href="/tip/포인트 센트릭 vs 롱 센트릭.pdf"
                    download
                    className="block w-full border border-white/20 text-white/80 py-2 px-4 rounded-lg
                               hover:bg-white/10 hover:border-white/40 transition-all duration-300 text-center backdrop-blur-sm"
                  >
                    {t("tipsPage.share4Download")}
                  </a>
                </div>
              </div>

              {/* All-on-X 보철 디자인 심화 자료 공유 */}
              <div
                className="bg-black/10 backdrop-blur-xl rounded-xl border border-white/10 overflow-hidden
                           hover:bg-black/15 hover:border-[#fde68a]/30 transition-all duration-500"
                style={{ boxShadow: '0 0 30px rgba(255, 255, 255, 0.08)' }}
              ...
              >
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-[#f8fafc]">{t("tipsPage.share5Title")}</h3>
                  <p className="text-[#f8fafc]/60 mb-4">{t("tipsPage.share5Desc")}</p>
                  <a
                    href="/tip/All-on-X 보철 디자인 심화.pdf"
                    download
                    className="block w-full border border-white/20 text-white/80 py-2 px-4 rounded-lg
                               hover:bg-white/10 hover:border-white/40 transition-all duration-300 text-center backdrop-blur-sm"
                  >
                    {t("tipsPage.share5Download")}
                  </a>
                </div>
              </div>

              {/* 전악 재건 교합 개념 리뷰 자료 공유 */}
              <div
                className="bg-black/10 backdrop-blur-xl rounded-xl border border-white/10 overflow-hidden
                           hover:bg-black/15 hover:border-[#fde68a]/30 transition-all duration-500"
                style={{ boxShadow: '0 0 30px rgba(255, 255, 255, 0.08)' }}
              ...
              >
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-[#f8fafc]">{t("tipsPage.share3Title")}</h3>
                  <p className="text-[#f8fafc]/60 mb-4">{t("tipsPage.share3Desc")}</p>
                  <a
                    href="/tip/전악 재건 교합 개념 리뷰.pdf"
                    download
                    className="block w-full border border-white/20 text-white/80 py-2 px-4 rounded-lg
                               hover:bg-white/10 hover:border-white/40 transition-all duration-300 text-center backdrop-blur-sm"
                  >
                    {t("tipsPage.share3Download")}
                  </a>
                </div>
              </div>
            </div>
